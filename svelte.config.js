 ...
 * `BASE_PATH=/VetCrewEmergency` typed into Git Bash on Windows arrives as
 * `C:/Program Files/Git/VetCrewEmergency`, because MSYS rewrites anything that looks
...
const config = {
	...
	kit: {
		...
		paths: {
			 ...
			 * /VetCrewEmergency/adopt/images/logo/…, which is a 404. Twenty-seven images in
