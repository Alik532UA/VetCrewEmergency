 ...
 */
export const PREFIX = 'vetcrewemergency_';
 ...
 * Every key is automatically prefixed with 'vetcrewemergency_'.
 *
 ...
 * `alik532ua.github.io/VetCrewEmergency/` is still a working address, so a reader who ever
