 ...
 * його цілком означало б піднімати браузер, і це вже роблять `tests/ui.spec.ts` та
 * `tests/scrollbar.spec.ts`. А от ДВА рішення всередині нього чисті й від браузера
