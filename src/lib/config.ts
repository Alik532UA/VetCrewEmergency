...
/**
 * Сайт самої організації.
 *
 * Цей сайт — один із її проєктів, а не вона сама, тож знак у підвалі веде туди, а
 * не на головну. Тут, а не в розмітці підвала: адреси в цьому проєкті живуть в
 * одному місці, і наступна, що знадобиться комусь ще, знайдеться поруч.
 */
export const VETCREW_SITE = 'https://sites.google.com/view/vetcrew';
