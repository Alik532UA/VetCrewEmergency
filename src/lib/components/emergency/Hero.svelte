...
<style>
	 ...
	 * лишитися з ОДНИМ рівним кольором тла: `tests/hero-background.spec.ts` читає в нього
	...
	/*
	 * Синій вогонь пари: чотири позиції з десяти, між червоними.
	 *
	 * Ні затримки, ні власної тривалості: розклад обох вогнів розписаний в
	 * ОДНОМУ циклі (`@keyframes` в `app.css`), і саме тому пауза між циклами
